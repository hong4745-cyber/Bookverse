...
const SLIDES = [
  ...
  { theme: 'fish', label: '무너진 질서 끝에서 비로소 발견한 삶의 가능성', words: [['무너진 질서','w1'],['끝에서','w2'],['비로소','w3'],['발견한','w4'],['삶의','w5'],['가능성','w6']], art: [['11_1','무너진 표본장','a1'],['12_1','이어진 물고기','a2'],['13_1','생명의 물고기','a3'],['10_1','물고기를 든 학자','a4'],['19-1','물고기 가계도','a5']] },
  { theme: 'philosophy', label: '길을 잃은 순간 철학 여행 열차가 도착했다', words: [['길을','w1'],['잃은 순간','w2'],['철학여행','w3'],['열차가','w4'],['도착했다','w5']], art: [['15_1','사색하는 사람','a1'],['16_1','소크라테스 조각상','a2'],['20-1','철학 여행 열차','a3'],['17_1','열차 안 철학자들','a4']] },
];
