...
<p align="center">
  <img width="1927" height="936" alt="Image" src="https://github.com/user-attachments/assets/e9f716c3-1c6c-434c-8453-08a80dc5598e" />
</p>
...
- 상세 페이지의 `COMMUNITY` 제목과 하단 `돌아가기` 버튼을 통한 메인 COMMUNITY 섹션 복귀
...
- LOGIN과 팝업 확인 액션에 테두리·그림자·눌림 효과를 공유하는 버튼 스타일 적용
- 팝업 확인 버튼은 호버 시 검은 배경과 흰색 텍스트로 상태를 명확하게 표시
...
12시간 숨김 상태와 관계없이 해상도 안내 팝업을 확인하려면 아래 주소를 사용합니다.

```text
http://localhost:5173/?showResolutionNotice=1
```
...
- 애니메이션은 시각적 효과뿐 아니라 키보드와 모션 감소 설정까지 함께 고려해야 합니다.
